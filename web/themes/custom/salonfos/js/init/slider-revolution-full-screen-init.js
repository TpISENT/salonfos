(function ($, Drupal, drupalSettings) {
  Drupal.behaviors.mtSliderRevolutionFullScreen = {
    attach: function (context, settings) {
      ...
      if (drupalSettings.salonfos.sliderRevolutionFullScreenInit.slideshowFullScreenNavigationStyle == "bullets") {
        var bulletsEnable = true,
        tabsEnable = false;
        thumbsEnable = false;
      } else if (drupalSettings.salonfos.sliderRevolutionFullScreenInit.slideshowFullScreenNavigationStyle == "titles_carousel") {
        var tabsEnable = true,
        bulletsEnable = false;
        thumbsEnable = false;
      } else {
      ...
      if ($(".transparent-header-active").length>0) {
        $(context).find('.slideshow-fullscreen .slider-revolution').once('mtSliderRevolutionFullScreenInit').revolution({
          ...
          delay: drupalSettings.salonfos.sliderRevolutionFullScreenInit.slideshowFullScreenEffectTime,
          ...
          navigation: {
            ...
            bullets:{
              ...
              space: 5,
              h_align:  drupalSettings.salonfos.sliderRevolutionFullScreenInit.slideshowFullScreenBulletsPosition,
              v_align:"bottom",
              h_offset: 0,
              v_offset: 20,
              tmp:"",
            ...
            touch:{
              touchenabled: drupalSettings.salonfos.sliderRevolutionFullScreenInit.slideshowFullScreenTouchSwipe,
              swipe_treshold:75,
              swipe_min_touches:1,
      ...
      $(context).find('.transparent-background').once('mtSliderRevolutionFullScreenBG').css("backgroundColor", "rgba(0,0,0," + drupalSettings.salonfos.slideshowCaptionOpacity + ")");
