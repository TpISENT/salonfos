jQuery(document).ready(function($) {
  ...
  if ($(".header-container.js-transparent-header header.header").length>0) {
    var color = $(".header-container.js-transparent-header header.header").css("background-color").replace(")", "," + drupalSettings.salonfos.transparentHeader.transparentHeaderOpacity + ")").replace("rgb", "rgba");
  ...
  if ($(".header-container.js-transparent-header .header-top").length>0) {
    var color = $(".header-container.js-transparent-header .header-top").css("background-color").replace(")", "," + drupalSettings.salonfos.transparentHeader.transparentHeaderOpacity + ")").replace("rgb", "rgba");
  ...
  if ($(".header-container.js-transparent-header .header-top-highlighted").length>0) {
    var color = $(".header-container.js-transparent-header .header-top-highlighted").css("background-color").replace(")", "," + drupalSettings.salonfos.transparentHeader.transparentHeaderOpacity + ")").replace("rgb", "rgba");
